...
const styles = {
    main: { position: "relative", width: "100%", minHeight: "100vh", overflow: "hidden", background: "#0f172a" },
    fullImage: { position: "fixed", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover", zIndex: 0, opacity: 0.1 },
    darkOverlay: { position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "rgba(0,0,0,0.65)", zIndex: 1 },
    overlay: { position: "relative", zIndex: 2, color: "white", width: "100%", height: "100%", padding: "3% 20px" },
    ...
    productsTitle: { fontSize: "clamp(1.8rem, 4vw, 2.5rem)", fontWeight: "bold", marginBottom: "0.5rem", textAlign: "center" },
    productsDesc: { fontSize: "clamp(0.95rem, 2vw, 1.1rem)", color: "#cbd5e1", marginBottom: "2rem", textAlign: "center" },
    ...
    productGrid: { display: "flex", gap: "2rem", padding: "0 1rem", justifyContent: "center", flexWrap: "wrap" },
